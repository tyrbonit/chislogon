(function() {
  ...
  var razryad = function(snum, unit, zero) {
    ...
    return snum.replace(/^([0-9])(?:(1[0-9])|(?:([02-9])([0-9])))$/g, function(m, s100, d011, d010, e011) {
      ...
      return [h100[s100], h011[d011], h010[d010], h011[e011], u].join(' ')
    })
  };
  ...
  var common = function(number, unit, zero, ondig) {
    ...
    return units.reverse().join(' ').trim();
  };
  ...
  var decimal = function(snum, options) {
  	options['off_base']=options['off_base']||false;
    options['off_part']=options['off_part']||false;
    options['zero_base']=options['zero_base']||false;
    options['zero_part']=options['zero_part']||false;
  ...
  var currency = function(summa, options) {
    ...
    var dflt_opt= {currency: "RUB", off_base: false, off_part: false};
    ...
    tnum[0] = /\d/.test(tnum[0]) ? common(tnum[0], options.unit.base, true, options.off_base) : "";
    tnum[1] = tnum[1] ? common(tnum[1], options.unit.part, false, options.off_part) : "";
    tnum = tnum.join(" ");
    return tnum
  };
